...
class DeliveryManagement extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $users = User::where('role', 'delivery')->select(['id', 'name', 'email', 'created_at']);
            return DataTables::of($users)
                ...
                ->addColumn('actions', function ($row) {
                    $editUrl = route('delivery-management.edit', $row->id);
                    $deleteUrl = route('delivery-management.destroy', $row->id);
        ...
        // Return the view
        return view('admin-panel.delivery-management.index');
    }
    ...
    {
        return view('admin-panel.delivery-management.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('delivery-management.index')->with('success', 'Profile created successfully.');
        } catch (\Exception $e) {
    ...
    public function edit($id)
    {
        ...
        return view('admin-panel.delivery-management.edit', compact('user', 'profile'));
    }
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('delivery-management.index')
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('delivery-management.index')->with('status', 'User deleted successfully!');
    }
}

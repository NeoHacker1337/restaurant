        ...
        <div class="mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
            <div class="!px-10 !py-12 card-body">
                ...
                <form method="POST" action="{{ route('register') }}" class="mt-10">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="text"
                                class="form-control @error('name') is-invalid @enderror form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                    ...
                    <div class="mb-3">
                        <label for="email"
                            class="inline-block mb-2 text-base font-medium">{{ __('Email Address') }}</label>
                    ...
                    <div class="mb-3">
                        <label for="email" class="inline-block mb-2 text-base font-medium">{{ __('Role') }}</label>
                    ...
                    <div class="mb-3">
                        <label for="password"
                            class="inline-block mb-2 text-base font-medium">{{ __('Password') }}</label>

    ...
    <div class="relative">
        ...
        <div class="mb-0 w-screen lg:mx-auto lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
            <div class="!px-10 !py-12 card-body">
                <a href="#!">
                    <img src="{{ asset('public/assets/images/logo-light.png') }}" alt="" class="hidden h-6 mx-auto dark:block">
                    <img src="{{ asset('public/assets/images/logo-dark.png') }}" alt="" class="block h-6 mx-auto dark:hidden">
                </a>
                ...
                <form class="mt-10" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="email" value="{{ old('email') }}"
                            ...
                            placeholder="Enter username or email" name="email">
                    </div>
                    @error('email')

...
@section('content')
                ...
                <div class="col-md-12">
                    <div class="page-title-inner hidden">
                        <div class="bg-page-title-inner">
                            <img class="parallax" src="{{ asset('public/frontend/assets/images/backgroup/page-title.jpg') }}"
                                alt="" />
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-12 tablet-mb-30">
                    <div class="image h-full wow fadeIn" data-wow-delay=".3s">
                        <img class="radius-20 h-full w-full"
                            src="{{ asset('public/frontend/assets/images/common/item_34.jpg') }}" alt="" />
                    </div>
                </div>
                <div class="col-lg-8 col-md-12 wow fadeIn" data-wow-delay=".5s">
                    <div class="about-content style1 relative radius-20 flex items-center justify-between">
                        <img class="absolute r-0 b-0"
                            src="{{ asset('public/frontend/assets/images/backgroup/layer_1.png') }}" alt="" />
                        <div class="content pr-30 mobile-mb-30 mobile-pr0">
                            <h2 class="color-3 title text-spacing-1 mb-25 mt--5">
                                Our Store history Basilico Since 1996.
                            </h2>
                            <p class="mb-15">
                                Our Basilico an unknown printer took a galley type and
                                scrambled make type specimen book. It has survived not only
                                five centuries, but also the leap into electronic
                                typesetting, remaining essentially unchanged. It was
                                popularisedsheets containing.
                            </p>
                            <p>
                        ...
                        <div class="inner-box gradient radius-20">
                            <img class="icon" src="{{ asset('public/frontend/assets/images/common/quote.png') }}"
                                alt="" />
                            <p class="font-1 fz-20 lh-1_75 white mb-28">
                                Basilico not only serves quality fast food dishes according
                                to strictly censored procedures, but also gives everyone.
                            </p>
                ...
                <div class="col-lg-8 col-md-12 tablet-mb-30 wow fadeIn" data-wow-delay=".3s">
                    <div class="about-content relative radius-20 flex items-center justify-between">
                        <img class="absolute l-0 t-0"
                            src="{{ asset('public/frontend/assets/images/backgroup/layer_2.png') }}" alt="" />
                        <div class="inner-box style radius-20 mobile-mb-30">
                            <img src="{{ asset('public/frontend/assets/images/common/item_35.png') }}" class="mb-20"
                                alt="" />
                            <h2 class="white text-spacing-1 mb-6 italic">100%</h2>
                            <h5 class="white text-spacing-0_5">Local ingredients</h5>
                        </div>
                        <div class="content m--8 pl-15">
                            <h2 class="color-3 title text-spacing-1 mb-24 mt--5">
                                There is a Whole Universe in Every Bite.
                            </h2>
                            <p class="mb-42">
                                Whether you’re a ketchup and mustard loyalist or you prefer
                                house sauce to no sauce, you can agree that every
                                cheeseburger has it’s own special flair. Top tip: house
                                sauce begs to be ordered. From smashed patties at Shake
                                Shack to Glamburgers at Honky Tonk.
                            </p>
                            <div class="flex">
                ...
                <div class="col-lg-4 col-md-12 wow fadeIn" data-wow-delay=".5s">
                    <div class="video wow fadeIn h-full radius-20" data-wow-delay=".2s">
                        <img class="img_video w-full h-full radius-20"
                            src="{{ asset('public/frontend/assets/images/backgroup/video_1.jpg') }}" alt="" />
                ...
                <div class="col-lg-4 col-md-12 tablet-mb-30 wow fadeIn" data-wow-delay=".3s">
                    <div class="image h-full">
                        <img class="radius-20 h-full w-full"
                            src="{{ asset('public/frontend/assets/images/common/item_35.jpg') }}" alt="" />
                    </div>
                </div>
                <div class="col-lg-8 col-md-12 wow fadeIn" data-wow-delay=".5s">
                    <div class="about-content style1 relative radius-20 flex items-center justify-between">
                        <img class="absolute r-0 t-0"
                            src="{{ asset('public/frontend/assets/images/backgroup/layer_3.png') }}" alt="" />
                        <div class="content mobile-mb-30 mt--25">
                            <h2 class="color-3 title text-spacing-1 mb-24">
                                Fast Delivery <br class="show-destop" />
                                Delivery or Takeaway.
                            </h2>
                            <p class="mb-20 pr-70">
                                Some of the world’s best cheese is made close to home! All
                                our deliciously melty Mozzarella is made with 100% Canadian
                                milk. We’re proud to support Canadian dairy farmers.
                            </p>
                            <ul class="icon-list style3 w-full">
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0"
                                        y="0" viewBox="0 0 408.576 408.576" style="enable-background: new 0 0 512 512"
                                        xml:space="preserve">
                                        <g>
                                            <path
                                                ...
                                                fill="#bb0001" data-original="#000000" class="" opacity="1">
                                            </path>
                                        </g>
                                    </svg>
                                    <span class="color-3">App Order & Delivery</span>
                                </li>
                                <li class="style">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0"
                                    ...
                                    <span class="color-3">Home Delivery</span>
                                </li>
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0"
                                    ...
                                    <span class="color-3">Takeout Available </span>
                                </li>
                                <li class="style">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0"
                                    ...
                                    <span class="color-3">multiple platforms payment </span>
                                </li>
                            </ul>
                        </div>
                        <div class="inner-box style2 gradient radius-20">
                            <div class="image mb-10 flex justify-end">
                                <img class="w-167 ml-auto"
                                    src="{{ asset('public/frontend/assets/images/common/item_36.png') }}"
                                    alt="" />
                            </div>
                            <h6 class="italic color-2 mb--5 uppercase text-spacing-1 color-2">
                                Call Us To Order
                            </h6>
                            ...
                            <div class="flex">
                                <a href="{{ route('order.page') }}" class="tf-button flex items-center">order online now</a>
                            </div>
                        </div>
                    </div>
                </div>
                              ...
                              "
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box">
                                            <div class="inner">
                                                <div class="icon mb-28">
                                                    <svg id="Capa_2" enable-background="new 0 0 512.009 512.009"
                                                        height="512" viewBox="0 0 512.009 512.009" width="512"
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box">
                                            <div class="inner">
                                                ...
                                                <h5 class="mb-0">Super Fast Order</h5>
                                            </div>
                                            <div class="hover-effect">
                                                <h5 class="mb-20">Super Fast Order</h5>
                                                <p class="color-5">
                                                    Lorem ipsum dolor sit amet, consectetur adipiscing
                                                    elit. Ut elit tellus, luctus nec ullamcorper
                                                    mattis.
    ...
    <section class="tf-section pb-134 pt-125">
        <img class="item-snack-bottom left" src="{{ asset('public/frontend/assets/images/common/item-07.png') }}"
            alt="">
        <img class="item-snack-bottom right" src="{{ asset('public/frontend/assets/images/common/item-07.png') }}"
            alt="">
        <div class="container w_1650">
            <div class="row">
                <div class="col-md-12 testimonial-wrapper style3 wow fadeIn" data-wow-delay=".3s">
                    <div class="swiper-prev-testimonial hide-mobile">
                        <svg class="reverse" xmlns="http://www.w3.org/2000/svg" version="1.1"
                            xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0"
                            viewBox="0 0 24 24" style="enable-background: new 0 0 512 512" xml:space="preserve">
                            <g>
                                <path fill="#0c0c0c" fill-rule="evenodd"
                    ...
                    <div class="swiper-next-testimonial hide-mobile">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <div class="icon">
                                            <img src="{{ asset('public/frontend/assets/images/icon/quote.png') }}"
                                                alt="" />
                                        </div>
                            ...
                            <ul>
                                <li class="testimonial-list-item">
                                    <a class="active" href="#0" data-slide-index="0">
                                        <img src="{{ asset('public/frontend/assets/images/common/avt_1.png') }}"
                                            alt="" />
                                    </a>
                                </li>
                                <li class="testimonial-list-item">
                                    <a href="#0" data-slide-index="1">
                                        <img src="{{ asset('public/frontend/assets/images/common/avt_2.png') }}"
                                            alt="" />
                                    </a>
                                </li>
                                <li class="testimonial-list-item">
                                    <a href="#0" data-slide-index="2">
                                        <img src="{{ asset('public/frontend/assets/images/common/avt_3.png') }}"
                                            alt="" />
                                    </a>
                                </li>
                                <li class="testimonial-list-item">
                                    <a href="#0" data-slide-index="3">
                                        <img src="{{ asset('public/frontend/assets/images/common/avt_4.png') }}"
                                            alt="" />
                                    </a>
                                </li>
                                <li class="testimonial-list-item">
                                    <a href="#0" data-slide-index="4">
                                        <img src="{{ asset('public/frontend/assets/images/common/avt_5.png') }}"
                                            alt="" />
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img src="{{ asset('public/frontend/assets/images/common/more.png') }}"
                                            alt="" />
                                    </a>
                                </li>
                            </ul>
        ...
        <div class="container w_1920 pd0">
            <div class="row">
                <div class="col-lg-3 col-md-6 pd0 wow fadeIn" data-wow-delay=".2s">
                    <img class="w-full h-full mb--8"
                        src="{{ asset('public/frontend/assets/images/common/item_37.jpg') }}" alt="" />
                </div>
                    ...
                    <div class="content-box pd-50 relative h-full tablet-center">
                        <div class="overlay absolute l-0 t-0 w-full h-full">
                            <img class="w-full h-full"
                                src="{{ asset('public/frontend/assets/images/backgroup/bg-box-3.jpg') }}"
                                alt="" />
                        </div>
                        <div class="relative z-1">
                            <img class="mb-20 w-96 h-96"
                                src="{{ asset('public/frontend/assets/images/icon/ic-about_1.png') }}" alt="" />
                            <h3 class="fz-40 mb-10 text-spacing-1_5">Meet The Teams</h3>
                            <p class="fz-17 mb-42 white">
                                Chicken Bites and Grilled Chicken Topping are made from
                                chickens raised without antibiotics and fed an all
                                vegetable.
                            </p>
                            <div class="flex">
                ...
                <div class="col-lg-3 col-md-6 pd0 wow fadeIn" data-wow-delay=".6s">
                    <img class="w-full h-full mb--8"
                        src="{{ asset('public/frontend/assets/images/common/item_38.jpg') }}" alt="" />
                </div>
                <div class="col-lg-3 col-md-6 pd0 wow fadeIn" data-wow-delay=".8s">
                    <div class="content-box pd-50 relative h-full tablet-center">
                        <div class="overlay absolute l-0 t-0 w-full h-full">
                            <img class="w-full h-full"
                                src="{{ asset('public/frontend/assets/images/backgroup/bg-box-4.jpg') }}"
                                alt="" />
                        </div>
                        <div class="relative z-1">
                            <img class="mb-20 w-96 h-96"
                                src="{{ asset('public/frontend/assets/images/icon/ic-about_2.png') }}" alt="" />
                            <h3 class="fz-40 mb-10 text-spacing-1_5">Join Us Teams</h3>
                            <p class="fz-17 mb-42 white">
                                Chicken Bites and Grilled Chicken Topping are made from
                                chickens raised without antibiotics and fed an all
                                vegetable.
    ...
    <section class="tf-section pt-130 pb-130">
        <div class="container w_1650">
            <div class="row">
                <div class="col-md-12 wow fadeIn" data-wow-delay=".3s">
                    <div class="swiper-container sl-product-3">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="product-3">
                                    <img src="{{ asset('public/frontend/assets/images/common/item_17.jpg') }}"
                                        alt="" />
                                    <div class="action">
                                        <a class="flex icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                            ...
                            <div class="swiper-slide">
                                <div class="product-3">
                                    <img src="{{ asset('public/frontend/assets/images/common/item_18.jpg') }}"
                                        alt="" />
                                    <div class="action">
                                        <a class="flex icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                            ...
                            <div class="swiper-slide">
                                <div class="product-3">
                                    <img src="{{ asset('public/frontend/assets/images/common/item_19.jpg') }}"
                                        alt="" />
                                    <div class="action">
                                        <a class="flex icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                            ...
                            <div class="swiper-slide">
                                <div class="product-3">
                                    <img src="{{ asset('public/frontend/assets/images/common/item_20.jpg') }}"
                                        alt="" />
                                    <div class="action">
                                        <a class="flex icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                            ...
                            <div class="swiper-slide">
                                <div class="product-3">
                                    <img src="{{ asset('public/frontend/assets/images/common/item_21.jpg') }}"
                                        alt="" />
                                    <div class="action">
                                        <a class="flex icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"

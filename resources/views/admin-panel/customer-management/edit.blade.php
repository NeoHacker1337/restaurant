...
@section('content')
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <form action="{{ route('customer-management.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT') 
                <div class="card">
                    <div class="card-body">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            @if ($profile->profile_image)
                                <img src="{{ asset('storage/app/private/public/' . '../' . $profile->profile_image) }}"
                                    alt="Profile Image" class="rounded-full w-32 h-32">
                            @else
                                <img src="{{ asset('public\assets\images\avatar-1.png') }}" alt="Default Avatar"

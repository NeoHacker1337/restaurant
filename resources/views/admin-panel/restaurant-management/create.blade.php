...
@section('content')
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <form action="{{ route('restaurant-management.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="restaurant_email" id="restaurant_email"
                            ...
                            class="form-input @error('restaurant_email') is-invalid @enderror border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                            required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="restaurant_address" id="restaurant_address"
                            class="form-input @error('restaurant_address') is-invalid @enderror border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="restaurant_city" id="restaurant_city"
                            class="form-input @error('restaurant_city') is-invalid @enderror border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="restaurant_state" id="restaurant_state"
                            class="form-input @error('restaurant_state') is-invalid @enderror border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                            value="{{ old('restaurant_state') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="restaurant_postal_code" id="restaurant_postal_code"
                            ...
                            value="{{ old('restaurant_postal_code') }}">
        ...
        @error('cuisine_type') is-invalid @enderror"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="seating_capacity" id="seating_capacity"
                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200
        @error('seating_capacity') is-invalid @enderror"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="checkbox" name="is_vegetarian" id="is_vegetarian" value="1"
                            class="@error('is_vegetarian') is-invalid @enderror"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="checkbox" name="accepts_online_orders" id="accepts_online_orders" value="1"
                            class="@error('accepts_online_orders') is-invalid @enderror"
                            {{ old('accepts_online_orders', true) ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="checkbox" name="offers_takeaway" id="offers_takeaway" value="1"
                            class="@error('offers_takeaway') is-invalid @enderror"
                            {{ old('offers_takeaway', true) ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="checkbox" name="has_parking" id="has_parking" value="1"
                            class="@error('has_parking') is-invalid @enderror" {{ old('has_parking') ? 'checked' : '' }}>
                        @error('has_parking')
                            <span class="invalid-feedback text-red-500" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="restaurant_description" id="restaurant_description" rows="4"
                            ...
                            @error('restaurant_description') is-invalid @enderror">{{ old('restaurant_description') }}</textarea>

     ...
     <div
         ...
         <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
             ...
             <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                 <div class="grow">
                     <h5 class="text-16">Menu Items</h5>
                 </div>
             ...
             <div class="card">
                 <div class="card-body">
                     ...
                     <table id="menu-items-table" class="display stripe group" style="width:100%">
                         <thead class="bg-slate-200 dark:bg-slate-800">
                             <tr>
                                 ...
                                 <th class="px-4 py-2 border border-slate-300 dark:border-slate-700">Price</th>
                                 <th class="px-4 py-2 border border-slate-300 dark:border-slate-700">Image</th>
                                 <th class="px-4 py-2 border border-slate-300 dark:border-slate-700">Availability</th>
                                 <th class="px-4 py-2 border border-slate-300 dark:border-slate-700">Category</th>
                                 <th class="px-4 py-2 border border-slate-300 dark:border-slate-700">Menu Type</th>
                                 <th class="px-4 py-2 border border-slate-300 dark:border-slate-700">Veg/Non-Veg</th>
                                 <th class="px-4 py-2 border border-slate-300 dark:border-slate-700">Actions</th>
                             </tr>
                         </thead>
                         <tbody>
                             <!-- Dynamic data will be inserted here using AJAX or Blade -->
                         </tbody>
                     </table>
     ...
     <script>
         $(document).ready(function() {
             $('#menu-items-table').DataTable({
                 ...
                 "columnDefs": [{
                     "targets": [ /* index of your availability_status column */ ],
                     "createdCell": function(td, cellData, rowData, row, col) {
                         $(td).html(cellData); // Ensure raw HTML is rendered
                     }
                 }],
             });

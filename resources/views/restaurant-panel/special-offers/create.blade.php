    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Add Special Offer's</h5>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="container">
                        ...
                        <form action="{{ route('special-offers.store') }}" method="POST">
                            @csrf
                            <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-6">
                                ...
                                <div class="col-12">
                                    <label for="price_in_type" class="inline-block mb-2 text-base font-medium">Price

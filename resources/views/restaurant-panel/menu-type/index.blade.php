     ...
     <div
         ...
         <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
             ...
             <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                 <div class="grow">
                     <h5 class="text-16">Menu Types</h5>
                 </div>
             ...
             <div class="card">
                 <div class="card-body">
                     ...
                     <table id="menu-types-table" class="display stripe group" style="width:100%">
                         <thead class="bg-slate-200 dark:bg-slate-800">
                             <tr>
                                 ...
                                 <th class="px-4 py-2 border border-slate-300 dark:border-slate-700">Start Time</th>
                                 <th class="px-4 py-2 border border-slate-300 dark:border-slate-700">End Time</th>
 ...
 @section('extra_js')
     ...
     <script>
         $(document).ready(function() {
             $('#menu-types-table').DataTable({
                 processing: true,
                 serverSide: true,
                 ajax: '{{ route('menu-types.index') }}',
                 columns: [{
                         data: 'DT_RowIndex',
                         name: 'DT_RowIndex',
                         orderable: false,
